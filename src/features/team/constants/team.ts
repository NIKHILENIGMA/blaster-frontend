...
export const teams: Record<TeamName, TeamInfo> = {
    KKR: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244087/KKR_NEW_LOGO_w8mgvq.png',
    ...
    CSK: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244086/CSK_NEW_LOGO_wy5jg7.png',
    ...
    MI: {
        name: 'Mumbai Indians',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244086/MI_NEW_LOGO_k3ufmm.png',
    ...
    RCB: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244087/RCB_NEW_LOGO_z7iu9h.png',
    ...
    SRH: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244085/SRH_NEW_LOGO_WITH_SCULPTURE_ciakp4.png',
    ...
    RR: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244087/RR_NEW_LOGO_puewl3.png',
    ...
    DC: {
        name: 'Delhi Capitals',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244085/DC_NEW_LOGO_WITH_ROBOT_CAT_p2xztt.png',
    ...
    PBKS: {
        name: 'Punjab Kings',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244088/PBKS_NEW_LOGO_e5x6ta.png',
    ...
    LSG: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244086/LSG_NEW_LOGO_v3wabb.png',
    ...
    GT: {
        name: 'Gujarat Titans',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778244086/GT_NEW_LOGO_f73kzn.png',
