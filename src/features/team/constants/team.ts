...
export const teams: Record<TeamName, TeamInfo> = {
    KKR: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673261/4_qblr7c.png',
    ...
    CSK: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673252/6_myzao7.png',
    ...
    MI: {
        name: 'Mumbai Indians',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673251/7_ustppa.png',
    ...
    RCB: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673254/2_eluazn.png',
    ...
    SRH: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673256/9_ra5rsq.png',
    ...
    RR: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673256/1_jxdhvm.png',
    ...
    DC: {
        name: 'Delhi Capitals',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673253/3_ut57yn.png',
    ...
    PBKS: {
        name: 'Punjab Kings',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673255/10_lntkaf.png',
    ...
    LSG: {
        ...
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673252/5_bzzt5u.png',
    ...
    GT: {
        name: 'Gujarat Titans',
        teamLogoUrl: 'https://res.cloudinary.com/dynbvnhcc/image/upload/v1778673250/8_swbnvw.png',
